...
const Login = () => {
  ...
  const sendForm = async e => {
    ...
    const fetchedData = await fetch(`https://instagram-database.youngwebdevs.now.sh/login/?userName=${inputUserName}&password=${inputPasword}`);
  ...
  return (
    <MainWrapper>
      ...
      {wrongUser && <WrongUserPopUp wrongUser={wrongUser}>Username or password are incorrect</WrongUserPopUp>}
